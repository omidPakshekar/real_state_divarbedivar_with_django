...
urlpatterns = [
    ...
    path('seller_product/', views.SellerListView.as_view(), name='list-seller-products'),
    path('seller_product/<slug:category_slug>/', views.SellerListView.as_view(), name='list-seller-products'),
    ...
    path('update/<int:id>/<str:slug>/', views.ProductUpdateView.as_view(), name='product-update')
