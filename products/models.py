...
class Product(models.Model):
    ...
    seller = models.ForeignKey(Seller, db_index=True, default=1, on_delete=models.CASCADE)
    ...
    # image
    image = models.ImageField( default='pic/image_404.png', upload_to='products/%Y/%m/%d', blank=True)
